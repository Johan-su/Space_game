...
float Camera_functions::screen_to_world_x(Camera *camera, I32 x)
{
    return camera->world_x + (x / camera->world_scale_x);
}


float Camera_functions::screen_to_world_y(Camera *camera, I32 y)
{
    return camera->world_y + (y / camera->world_scale_y);
}


I32 Camera_functions::world_to_screen_x(Camera *camera, float x)
{
    return (I32)((x - camera->world_x) * camera->world_scale_x);
}


I32 Camera_functions::world_to_screen_y(Camera *camera, float y)
{
...
void Camera_functions::zoom(Camera *camera, int mx, int my, float scale)
{
